...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const page =
        document.querySelector(".sbl-sales-page");
    ...
    const revealItems =
        page.querySelectorAll(".sales-reveal");
    ...
    if (followupButton) {
        ...
        followupButton.addEventListener(
            ...
            () => {
                ...
                followupButton.style.background =
                    "#3dbb78";
    ...
    /* =====================================================
       CUSTOMER IMAGE PARALLAX
    ====================================================== */

    const customerImage =
        page.querySelector(
            ".sales-customer-image"
        );
    ...
    if (
        ...
        customerImage.addEventListener(
            "mousemove",
            event => {
