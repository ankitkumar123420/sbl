...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const page =
        document.querySelector(".sbl-finance-page");

    if (!page) return;


    /* =====================================================
       FINANCE MODULE SWITCHER
    ====================================================== */

    const moduleButtons =
        page.querySelectorAll(".finance-module-item");

    const previewTitle =
        page.querySelector(
            ".finance-preview-header strong"
        );

    const previewTag =
        page.querySelector(
            ".finance-preview-header span"
        );
    ...
    const financeModules = {
        ...
        receivables: {
            ...
            tag: "FINANCE / RECEIVABLES"
        },

        payables: {
            title: "Payables overview",
            tag: "FINANCE / PAYABLES"
        },
    ...
    moduleButtons.forEach(button => {
        ...
        button.addEventListener("click", () => {
            ...
            const module =
                button.dataset.financeModule;

            const data =
                financeModules[module];
    ...
    /* =====================================================
       AUTOMATION ACTIVE NODE
    ====================================================== */

    const autoSteps =
        page.querySelectorAll(".finance-auto-step");
    ...
    /* =====================================================
       HERO DASHBOARD MOUSE EFFECT
    ====================================================== */

    const command =
        page.querySelector(".finance-command");
    ...
    const revealElements = [
        ...page.querySelectorAll(
            ".finance-problem-heading, " +
            ".finance-problem-card, " +
            ".finance-platform-heading, " +
            ".finance-platform-layout, " +
            ".finance-finance-image, " +
            ".finance-receivables-copy, " +
            ".finance-reporting-header, " +
            ".finance-report-card, " +
            ".finance-automation-heading, " +
            ".finance-auto-step, " +
            ".finance-final-copy"
        )
    ];
    ...
    revealElements.forEach(
        (element, index) => {
            ...
            element.style.transition =
                `
                opacity .7s ease ${index * .035}s,
                transform .7s cubic-bezier(.16,1,.3,1) ${index * .035}s
                `;
