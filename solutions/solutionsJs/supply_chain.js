...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const page = document.querySelector(".sbl-sc-page");
    ...
    const flowCards = page.querySelectorAll(".sc-flow-card");
    ...
    if (flowCards.length) {
        ...
        setInterval(() => {
            ...
            flowCards[activeFlow].classList.add("active");

            activeFlow++;

            if (activeFlow >= flowCards.length) {
                activeFlow = 0;
            }
    ...
    const controlVisual =
        page.querySelector(".sc-control-visual");

    const modules =
        page.querySelectorAll(".sc-module");
    ...
    if (
        ...
        controlVisual.addEventListener("mousemove", (event) => {
        ...
        controlVisual.addEventListener("mouseleave", () => {
    ...
    const dashboard =
        page.querySelector(".sc-dashboard-window");
    ...
    /* =====================================================
       AUTOMATION NODE CYCLE
    ===================================================== */

    const autoNodes =
        page.querySelectorAll(".sc-auto-node");
    ...
    if (autoNodes.length) {
        ...
        setInterval(() => {
            ...
            autoNodes[autoIndex].classList.add("active");

            autoIndex++;

            if (autoIndex >= autoNodes.length) {
                autoIndex = 0;
            }
    ...
    revealElements.forEach((element, index) => {
        ...
        element.style.transition =
            `opacity .75s ease ${index * .03}s,
             transform .75s cubic-bezier(.16,1,.3,1) ${index * .03}s`;
