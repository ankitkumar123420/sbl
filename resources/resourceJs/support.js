...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const supportPage =
        document.querySelector(".sbl-support-page");
    ...
    const faqItems =
        supportPage.querySelectorAll(".sbl-faq-item");

    const filterButtons =
        supportPage.querySelectorAll(".sbl-faq-filter");

    const searchInput =
        document.getElementById("sblFaqSearch");

    const noResults =
        document.getElementById("sblFaqNoResults");


    /* =====================================================
       FAQ OPEN/CLOSE

       HTML <details> already handles this.
       This JS only makes sure only one FAQ stays open.
    ===================================================== */
    ...
    function searchFAQs() {
        ...
        faqItems.forEach(function (item) {
            ...
            const answer =
                item.querySelector(".sbl-faq-answer");
    ...
    if (
        ...
        contact.addEventListener(
            ...
            function (event) {
                ...
                contactDecoration.style.transform =
                    `translate(${moveX}px, ${moveY}px)`;
